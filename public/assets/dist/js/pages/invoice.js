...
$(document).ready(function () {
    ...
    function calculateSummary() {
        ...
        $("#rowContainer .card").each(function () {
            ...
            const unitPrice =
                parseFloat($(this).find(".unit_price").val()) || 0;
            const taxRate =
                parseFloat($(this).find(".tax option:selected").data("tax")) ||
                0;
        ...
        if (discountTiming === "before_tax") {
            if (discountType === "percentage") {
                ...
                $("#discount_timing").prop("disabled", false);
            } else {
                $("#discount_timing").prop("disabled", true);
        ...
        // Set max attribute to prevent typing more
        $("#paid").attr("max", grandTotal.toFixed(2));
        ...
        $("#due").text(isNaN(due) ? "0.00" : due.toFixed(2));
    }
    ...
    $(document).on(
        "input change",
        "#discount, #discount_type, #discount_timing",
        function () {
            calculateSummary();
        }
    );

    // Paid input change updates due
