        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12 m-auto">
                    ...
                    <!-- form start -->
                    <form method="POST" action="{{ route('quote.update', $quoteData->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="card">
                                        ...
                                        <div class="input-group mb-3">
                                            <select class="form-control select2" name="client_id" id="client" required>
                                                @foreach ($clients as $client)
                                                    <option {{ $client->id == $quoteData->client_id ? 'selected' : '' }}
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="quote_number"
                                                ...
                                                value="{{ $quoteData->quote_number }}" required>
                                        </div>
                                        @error('quote_number')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                <input type="date" class="form-control" required name="quote_date"
                                                    value="{{ $quoteData->quote_date->format('Y-m-d') }}">
                                            </div>
                                            @error('quote_date')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                            ...
                                            <div class="card-body">
                                                <div class="row d-flex justify-content-between">
                                                    <div class="form-group col-md-3 col-12">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <select class="form-control select2 product_id"
                                                                name="product_id[]" required>
                                                                <option value="">Select Product</option>
                                                                @foreach ($products as $product)
                                                                    <option value="{{ $product->id }}"
                                                                        {{ $product->id == $quoteProduct->product_id ? 'selected' : '' }}
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <input type="number" class="form-control qty" name="qty[]"
                                                            value="{{ $quoteProduct->qty }}" required>
                                                    </div>

                                                    <div class="form-group col-md-2">
                                                        <label>Unit Price <span class="text-danger">*</span></label>
                                                        <input type="number" class="form-control unit_price"
                                                            name="unit_price[]" value="{{ $quoteProduct->unit_price }}" required>
                                                    </div>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <select class="form-control tax" id="tax" name="tax_id[]">
                                                                ...
                                                                @foreach ($taxes as $tax)
                                                                    <option {{ $quoteProduct->tax_id == $tax->id ? 'selected' : '' }}
                                            ...
                                            <div class="col-12 col-md-4 col-lg-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select name="discount_timing" id="discount_timing"
                                                        class="form-control">
                                                        <option {{ $quoteData->discount_timing == 'before_tax' ? 'selected' : '' }} value="before_tax">Applied Before Tax</option>
                                                        <option {{ $quoteData->discount_timing == 'after_tax' ? 'selected' : '' }} value="after_tax">Applied After Tax</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-4 col-lg-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select name="discount_type" id="discount_type" class="form-control">
                                                        <option {{ $quoteData->discount_type == 'flat' ? 'selected' : '' }} value="flat">Flat</option>
                                                        <option {{ $quoteData->discount_type == 'percentage' ? 'selected' : '' }} value="percentage">Percentage</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-4 col-lg-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" class="form-control" id="discount"
                                                        name="discount" placeholder="Enter discount amount" value="{{ $quoteData->discount }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal fade" id="clientModal" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="clientForm" method="POST" action="{{ route('quote.addClientAjax') }}">
                    @csrf
