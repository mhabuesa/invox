                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('customer.create') }}" class="btn btn-primary btn-sm float-right"> <i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button"
                                                    ...
                                                    onclick="deleteCustomer(this)" data-id="{{ $customer->id }}">
...
@push('footer')
    ...
    <script>
        ...
        // Delete Customer Confirmation alart
