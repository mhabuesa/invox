...
<head>
    ...
    @endif
    <link rel="stylesheet" href="{{ asset('assets') }}/invoice/first.css">
                ...
                <div class="cs-invoice_head cs-type1 cs-mb25">
                    <div class="cs-invoice_left">
                        ...
                        <p class="cs-invoice_date cs-primary_color cs-m0"><b class="cs-primary_color">Date:
                            </b>{{ $invoice->invoice_date->format('d-M-Y') }}</p>
                    </div>
                    <div class="cs-invoice_right cs-text_right">
                        <div class="cs-logo cs-mb5"><img width="75" src="{{ asset($setting->logo) }}"
                                alt="Logo"></div>
                    </div>
                </div>
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th class="cs-width_3 cs-semi_bold cs-primary_color cs-focus_bg cs-text_right">
                                            Total</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @if ($invoice->items)
                                        @foreach ($invoice->items as $key => $item)
                                            <tr>
                                                ...
                                                <td class="cs-width_3">{{ $item->product->description }}</td>
                                                <td class="cs-width_1">{{ $item->qty }}</td>
                                                <td class="cs-width_2">{{ currency($item->unit_price) }}</td>
                            ...
                            <div class="cs-right_footer">
                                <table>
                                    <tbody>
                                        ...
                                        <tr class="cs-border_left">
                                            <td class="cs-width_3 cs-semi_bold cs-primary_color cs-focus_bg">Discount
                                            </td>
                                            <td
                                                class="cs-width_3 cs-semi_bold cs-focus_bg cs-primary_color cs-text_right">
