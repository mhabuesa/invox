        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12 m-auto">
                    ...
                    <!-- form start -->
                    <form method="POST" action="{{ route('invoice.update', $invoiceData->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="card">
                                        ...
                                        <div class="input-group mb-3">
                                            <select class="form-control select2" name="client_id" id="client" required>
                                                @foreach ($clients as $client)
                                                    <option {{ $client->id == $invoiceData->client_id ? 'selected' : '' }}
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="invoice_number"
                                                ...
                                                value="{{ $invoiceData->invoice_number }}" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                <input type="date" class="form-control" required name="invoice_date"
                                                    value="{{ $invoiceData->invoice_date->format('Y-m-d') }}">
                                            </div>
                                            @error('invoice_date')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                                ...
                                                <div class="row d-flex justify-content-between">
                                                            ...
                                                            <select class="form-control select2 product_id"
                                                                ...
                                                                @foreach ($products as $product)
                                                                    <option value="{{ $product->id }}"
                                                                        {{ $product->id == $invoiceProduct->product_id ? 'selected' : '' }}
                                                    ...
                                                    <div class="form-group col-md-2">
                                                        ...
                                                        <input type="number" class="form-control qty" name="qty[]"
                                                            value="{{ $invoiceProduct->qty }}" required>
                                                    </div>

                                                    <div class="form-group col-md-2">
                                                        <label>Unit Price <span class="text-danger">*</span></label>
                                                        <input type="number" class="form-control unit_price"
                                                            name="unit_price[]" value="{{ $invoiceProduct->unit_price }}" required>
                                                    </div>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <select class="form-control tax" id="tax" name="tax_id[]">
                                                                ...
                                                                @foreach ($taxes as $tax)
                                                                    <option {{ $invoiceProduct->tax_id == $tax->id ? 'selected' : '' }}
                                            ...
                                            <div class="col-12 col-md-4 col-lg-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select name="discount_timing" id="discount_timing"
                                                        class="form-control">
                                                        <option {{ $invoiceData->discount_timing == 'before_tax' ? 'selected' : '' }} value="before_tax">Applied Before Tax</option>
                                                        <option {{ $invoiceData->discount_timing == 'after_tax' ? 'selected' : '' }} value="after_tax">Applied After Tax</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-4 col-lg-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select name="discount_type" id="discount_type" class="form-control">
                                                        <option {{ $invoiceData->discount_type == 'flat' ? 'selected' : '' }} value="flat">Flat</option>
                                                        <option {{ $invoiceData->discount_type == 'percentage' ? 'selected' : '' }} value="percentage">Percentage</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-4 col-lg-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="number" class="form-control" id="discount"
                                                        name="discount" placeholder="Enter discount amount" value="{{ $invoiceData->discount }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
